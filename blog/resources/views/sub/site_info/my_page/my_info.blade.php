...
<div id="section_inner">
    <h2 class="sub_page_title">회원정보 관리</h2>
    <form action="" class="join_form info">
        <ul>
            ...
            <li>
                <div class="all_line">
                    <div class="input_title">유선전화 </div>
                    <div class="input_box">
            ...
            <li>
                <div class="all_line">
                    <div class="input_title">준비하는 시험 </div>
                    <div class="input_box">
                        <select name="">
                        ...
                        <p>*회원가입 후 최초 1회만 수정이 가능합니다. 수정이 필요할 시 관리자에게 문의해주세요.</p>
                    </div>
                </div>
            </li>
            <li>
                <div class="all_line">
                    <div class="input_title">응시지역 </div>
                    <div class="input_box">
                        <input type="text">
                    </div>
                </div>
            ...
            <li>
                <div class="all_line">
                    <div class="input_title">학원 알게된 동기 </div>
                    <div class="input_box">
                        <select name="">
